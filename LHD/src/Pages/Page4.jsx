const Page4 = () => {
  ...
  return (
    <div className='relative top-0 md:px-48 lg:px-48'>
      <div className="max-w-7xl mx-auto py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-8">
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="bg-sky-100 mx-auto flex flex-col items-center overflow-hidden rounded-2xl shadow-lg p-4 sm:p-6 md:p-8">
              ...
              <div className="text-center">
                <div className="font-bold text-lg sm:text-md md:text-md mb-2">{testimonial.name}</div>
                <div className="font-semibold text-sm sm:text-md md:text-ld mb-2">{testimonial.designation}</div>
                <p className="text-gray-700 text-sm sm:text-md md:text-md">
